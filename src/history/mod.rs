...
pub use store::{
    ...
    DeploymentLogFormat, DeploymentLogRecord, DeploymentMetadata, DeploymentQuery,
    DeploymentRecord, DestinationReferenceSummary, GitWorktree, HistoryError, HistoryStore,
