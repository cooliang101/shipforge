...
- RSA regressions use generated temporary identities and a loopback SSH server to exercise OpenSSH/PEM loading and SHA-512/SHA-256 authentication. Signature-selection tests reject an explicit SHA-1-only advertisement and cover servers without EXT_INFO. They never read personal keys or production destinations.
